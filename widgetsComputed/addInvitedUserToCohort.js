return function(){
    ...
    let cohortOwnerType = $getUser('currentCohortOwnerType')
    ...
    if (isInvite == true){
        ...
        if(accountType == "Mentor"){
            ...
            if(cohortOwnerType == 'ProgrammePartner'){
            ...
            if(cohortOwnerType == 'Mentor'){
                console.log('Cannot add mentor to mentor cohort')
            }
